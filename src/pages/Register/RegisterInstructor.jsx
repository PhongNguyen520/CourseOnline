...
import {ValidIcon, InvalidIcon} from "../../assets/icons/Icons";
    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <div className={cx('title')}>BECOME A INSTRUCTOR</div>
                <div className={cx('currentForm')}>
                    <form className={cx('currentForm_content')}
                    ...
                    >
                        ...
                        <div className={cx('form_row')}>
                            <label htmlFor="dateOfBirth">
                                Date of Birth
                                <span className={cx({valid: validDob, hide: !validDob})}>
            <ValidIcon/>
        </span>
                                <span
                                    className={cx({
                                        hide: validDob || !dob,
                                        invalid: !validDob && dob,
                                    })}
                                >
            <InvalidIcon/>
        </span>
                            ...
                            <p
                                id="uiddob"
                                className={cx({
                                    instructions: dobFocus && !validDob,
                                    offscreen: !(dobFocus && !validDob),
                                })}
                            >
                                <span>Please select a valid date of birth</span>
                            </p>
                        </div>
                        ...
                        <div className={cx('form_row')}>
                            ...
                            {nameImage && (
                                <img src={nameImage} alt="avatar" className={cx('container__image')}></img>
                            )}
                        </div>
